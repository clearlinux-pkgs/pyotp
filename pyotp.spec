...
Version  : 2.9.0
Release  : 30
URL      : https://github.com/pyauth/pyotp/archive/v2.9.0/pyotp-2.9.0.tar.gz
Source0  : https://github.com/pyauth/pyotp/archive/v2.9.0/pyotp-2.9.0.tar.gz
...
%prep
%setup -q -n pyotp-2.9.0
cd %{_builddir}/pyotp-2.9.0
pushd ..
cp -a pyotp-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690554408
