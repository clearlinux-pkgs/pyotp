...
Version  : 2.5.1
Release  : 16
URL      : https://github.com/pyauth/pyotp/archive/v2.5.1/pyotp-2.5.1.tar.gz
Source0  : https://github.com/pyauth/pyotp/archive/v2.5.1/pyotp-2.5.1.tar.gz
...
%prep
%setup -q -n pyotp-2.5.1
cd %{_builddir}/pyotp-2.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612294939
...
cp %{_builddir}/pyotp-2.5.1/LICENSE %{buildroot}/usr/share/package-licenses/pyotp/a3a0fec34fa1214c0d3791df08cc5c15f0cdd756
